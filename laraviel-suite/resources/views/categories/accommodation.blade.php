...
<div class="container-fluid p-5 accomodation-bg">
        ...
        <div class="col-md-4">
            <div class="suite card">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-outline-light">Book now</button>
                    <button class="btn btn-outline-light" data-toggle="modal" data-target="#deluxeAmenitiesModal">Check amenities</button>
                </div>
            </div>
        </div>
        <div class="col-md-4">
    ...
    <h2 class="section-title text-left">LUXURY SUITES</h2>
    <div class="row justify-content-around">
        <div class="col-md-4">
            <div class="suite card">
                <img src="./images/standard 1.png" class="card-img-top" alt="Luxury Room">
                <div class="card-body">
                    <h3 class="card-title">LUXURY ROOM</h3>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <h4 class="suite-price">Php 12,899/per night</h4>
                    <button class="btn btn-outline-light">Book now</button>
                    <button class="btn btn-outline-light" data-toggle="modal" data-target="#luxuryAmenitiesModal">Check amenities</button>
                </div>
            </div>
        </div>
        <div class="col-md-4">
