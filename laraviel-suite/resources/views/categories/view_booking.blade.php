...
<body>
    <div class="container">
        ...
        <div class="stay-progress">
            ...
            <ul>
                ...
                <li class="highlight-text"><strong>Remaining Days:</strong> {{ $remainingDays }}</li>
            </ul>
        </div>
    ...
    <form action="{{ route('feedback.store') }}" method="POST">
        @csrf
        <h2 class="stay-experience-title">Stay Experience</h2>
        ...
        <textarea name="feedback" placeholder="Describe your experience..."></textarea>
